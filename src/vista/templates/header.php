...
<head>
  ...
  <link href="<?php echo constant('URL'); ?>public/css/main.css?v=3" rel="stylesheet">
  ...
  <ul class="navbar-nav bg-gradient-blue sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTI" class="collapse"  data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="<?php echo constant('URL'); ?>tipoficha/">Lista</a>
          <a class="collapse-item" href="<?php echo constant('URL'); ?>tipoficha/guardar/">Ingresar</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapsePI" class="collapse"  data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="<?php echo constant('URL'); ?>permisoficha/">Lista</a>
          <a class="collapse-item" href="<?php echo constant('URL'); ?>permisoficha/guardar">Ingresar</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapseCF" class="collapse"  data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="<?php echo constant('URL'); ?>seccionficha/">Secciones</a>
          <a class="collapse-item" href="<?php echo constant('URL'); ?>preguntaficha/">Preguntas</a>
        </div>
      </div>
    </li>
    ...
    <li class="nav-item">
      ...
      <div id="collapseGS" class="collapse"  data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="<?php echo constant('URL'); ?>gruposocioeconomico/">Lista</a>
          <a class="collapse-item" href="<?php echo constant('URL'); ?>gruposocioeconomico/guardar">Ingresar</a>
        </div>
      </div>
    </li>
