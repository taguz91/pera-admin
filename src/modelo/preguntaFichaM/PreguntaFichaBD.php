...
abstract class PreguntaFichaBD{
    ...
    static function insertarPreguntaFicha(PreguntaFichaMD $nuevaPregunta){
       ...
       return $pst->execute(array($nuevaPregunta->getIdSeccionFicha(), $nuevaPregunta->getPreguntaFicha(),
    ...
    static function seleccionarPreguntaFicha($key, int $op){
    ...
    static function actualizarPreguntaFicha(PreguntaFichaMD $pregunta){
        ...
        return $pst->execute(array($pregunta->getIdSeccionFicha(), $pregunta->getPreguntaFicha(),
                                    $pregunta->getPreguntaFichaAyuda(), $pregunta->getPreguntaFichaRespuestaTipo(),
                                    $pregunta->getPreguntaFichaTipo(), $pregunta->getPreguntaFichaActiva(),
                                    $pregunta->getIdPreguntaFicha()));

    }

    static function eliminarPreguntaFicha(PreguntaFichaMD $pregunta){
